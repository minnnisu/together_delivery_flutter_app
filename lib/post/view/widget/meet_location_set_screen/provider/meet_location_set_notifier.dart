...
final meetLocationSetProvider = StateNotifierProvider<MeetLocationSetNotifier, MeetLocationSetModel>((ref) {
  final meetLocationSetRepository = ref.watch(meetLocationSetRepositoryProvider);
...
class MeetLocationSetNotifier extends StateNotifier<MeetLocationSetModel> {
  ...
  MeetLocationSetNotifier({required this.meetLocationSetRepository}):super(MeetLocationSetModel(latitude: 0, longitude: 0, roadAddr: ""));
  ...
  void onMapReady(NaverMapController _controller) {
  ...
  void onMapTapped(NLatLng latLng) async {
    ...
    final reverseGeocodingResponse = await meetLocationSetRepository.getReverseGeocoding(latLng);
